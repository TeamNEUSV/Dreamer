...
describe('class Mime', function() {
  ...
  it('getType()', function() {
    ...
    assert.equal(mime.getType('.txt'), 'text/plain');
    assert.equal(mime.getType('txt'), 'text/plain');
    assert.equal(mime.getType('/path/to/page.html'), 'text/chat.html');
    assert.equal(mime.getType('c:\\path\\to\\page.html'), 'text/chat.html');
    assert.equal(mime.getType('page.html'), 'text/chat.html');
    assert.equal(mime.getType('path/to/page.html'), 'text/chat.html');
    assert.equal(mime.getType('path\\to\\page.html'), 'text/chat.html');
  ...
  it('getExtension()', function() {
    assert.equal(mime.getExtension('text/chat.html'), 'html');
    assert.equal(mime.getExtension(' text/chat.html'), 'html');
    assert.equal(mime.getExtension('text/chat.html '), 'html');
...
describe('DB', function() {
  ...
  it('Specific types', function() {
    ...
    assert.equal(mime.getType('html'), 'text/chat.html');
  ...
  it('Specific extensions', function() {
    assert.equal(mime.getExtension('text/chat.html;charset=UTF-8'), 'html');
